...
//     let content = `<table class="table table-striped"><tr><th>Username</th><th>Password</th><th>Email</th><th>Name</th><th>Age</th>
//                     <th>Address</th><th>Avatar</th><th colspan="2">Action</th></tr>`;
//     for (let i = 0; i < data.length; i++) {
//         content += `<tr><td >${data[i].username}</td><td >${data[i].password}</td><td >${data[i].email}</td><td >${data[i].name}</td><td >${data[i].age}</td><td >${data[i].address}</td>
